...
//       <SortableList
//         onSortEnd={onSortEnd}
//         className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:grid-cols-5"
//         draggedItemClassName="shadow-md p-2 m-2 cursor-grab border"
//       >
//         {items.map(({ id, image, selected }) => (
//           <SortableItem key={id}>
//             <div className={`relative ${selected ? 'border border-blue-600' : ''} flex m-3 cursor-grab`}>
//               <input
//                 type="checkbox"
//                 checked={selected}
//                 onChange={() => toggleSelect(id)}
...
//               />
//               <img
//                 className="w-full max-h-40 pointer-events-none rounded-lg"
//                 src={image}
//                 alt="images"
//               />
//             </div>
